...
Parameters such as hash table size were tuned for best tradeoff between performance and accuracy.
...
Licensed under [MIT](https://github.com/Sewer56/lossless-transform-utils/blob/main/LICENSE).
